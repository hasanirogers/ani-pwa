...
import { getPWADisplayMode } from '../../shared/utilities';
...
export class AniFooterNav extends LitElement {
  ...
  @state()
  displayMode: string = getPWADisplayMode()
    ...
    return html`
      ...
      ${this.displayMode === 'browser'
        ? html`
          <ul>
            <li>
              <a href="https://play.google.com/store/apps/details?id=com.anibookquotes.twa&hl=en_US" target="_blank">
                <svg xmlns="http://www.w3.org/2000/svg" id="artwork" version="1.1" viewBox="0 0 238.96 70.87">
                  <defs>
                    <style>.st0{fill:#4285f4}.st1{fill:#a6a6a6}.st2{stroke:#fff;stroke-miterlimit:10;stroke-width:.2px}.st2,.st3{fill:#fff}.st4{fill:#34a853}.st5{fill:#fbbc04}.st6{fill:#ea4335}</style>
                  </defs>
